                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="">
                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/landingpage/index.html" target="_blank">
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/email-templates/email-welcome.html">
                                                    <span class="pcoded-mtext">Welcome Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/email-templates/email-password.html">
                                                    <span class="pcoded-mtext">Reset Password</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/email-templates/email-newsletter.html">
                                                    <span class="pcoded-mtext">Newsletter Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/email-templates/email-launch.html">
                                                    <span class="pcoded-mtext">App Launch</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="https://colorlib.com//polygon/adminty/admin/extra-pages/email-templates/email-activation.html">
