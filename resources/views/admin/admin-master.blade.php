                        ...
                        <div  id="mainnav">
                            <div >
                                <ul  class="nav-menu custom-scrollbar">
                                        ...
                                        <li  class="dropdown"><a class="nav-link menu-title" href="#"><i data-feather="home"></i><span>{{trans('admin.mem.member')}}</span>
                                        ...
                                        <li class="sidebar-title">
                                            <div>
                                                <h6 class="lan-8">{{trans('admin.menu_titles.system')}}</h6>
