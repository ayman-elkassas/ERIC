...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-main-header">
        <div class="main-header-right row m-0">
            ...
            <div class="main-header-left">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('admin-cuba')}}/assets/images/logo/logo.png" alt=""></a></div>
    ...
    <div class="page-body-wrapper sidebar-icon">
        ...
        <header class="main-nav" sidebar-layout="iconcolor-sidebar">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{asset('admin-cuba')}}/assets/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="{{asset('admin-cuba')}}/assets/images/logo/logo.png" alt=""></a>
                <div class="back-btn"><i class="fa fa-angle-left"></i></div>
                <div class="toggle-sidebar"><i class="status_toggle middle" data-feather="grid" id="sidebar-toggle"> </i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('admin-cuba')}}/assets/images/logo/logo-icon.png" alt=""></a></div>
            <nav>
                <div class="main-navbar">
                    <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                    <div id="mainnav">
                        <ul class="nav-menu custom-scrollbar">
                            <li class="back-btn"><a href="index.html"><img class="img-fluid" src="{{asset('admin-cuba')}}/assets/images/logo/logo-icon.png" alt=""></a>
                        ...
                        <label class="badge badge-danger">New</label></span></a>
                            ...
                            <li class="dropdown"><a class="nav-link menu-title link-nav" href="kanban.html"><i data-feather="monitor"> </i><span>kanban
                        <label class="badge badge-primary">Latest</label></span></a></li>
                            ...
                            <li class="dropdown"><a class="nav-link menu-title link-nav" href="http://admin.pixelstrap.com/cuba/starter-kit/index.html" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
