    ...
    <div class="flex-grow-1">
        <div class="h-100 d-md-flex align-items-end auth-side-img">
            <div class="col-sm-10 auth-content w-auto">
                ...
                <h1 class="text-white my-4">{{trans('admin.login_page.welcome')}}</h1>
                <h4 class="text-white font-weight-normal">{{trans('admin.login_page.desc1')}}<br />{{trans('admin.login_page.desc2')}}</h4>
            </div>
        </div>
        <div class="auth-side-form">
            <form method="post" action="{{FAdminAuthUrl('login')}}">
                <div class=" auth-content">
                    <img src="assets/images/auth/auth-logo-dark.html" alt="" class="img-fluid mb-4 d-block d-xl-none d-lg-none">
                    <h3 class="mb-4 f-w-400">{{trans('admin.login_page.title')}}</h3>
                    ...
                    <div class="form-group text-left mt-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="rememberme" value="1" class="custom-control-input input-primary" id="customCheckdefh2" checked="">
                            <label class="custom-control-label" for="customCheckdefh2">Save credentials</label>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-block btn-primary mb-0">Sign in</button>
                    <div class="text-center">
                        ...
                        <p class="mb-2 mt-4 text-muted">Forgot password? <a href="{{FAdminAuthUrl('forget-password')}}" class="f-w-400">Reset</a></p>
                        <p class="mb-0 text-muted">Don’t have an account? <a href="{{FAdminAuthUrl('register')}}" class="f-w-400">SignUp</a></p>
                    </div>
                </div>
            </form>
        </div>
