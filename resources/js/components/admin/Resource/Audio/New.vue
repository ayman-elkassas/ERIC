            ...
            <template>
                <div class="center">
                    <vs-alert color="warn">
                        <template #title>
                            <span v-if="status===1">
                                <i class='bx bx-plus' ></i> Add New Audio List
                            </span>
                            <span v-else-if="status===2">
                                <i class='bx bx-edit' ></i> Edit Audio List
                            </span>
                        </template>
                ...
                <vs-row w="12">
                    <vs-col w="12">
                        <file-pond
                            ...
                            accepted-file-types="audio/mp3, audio/mpeg"
                    ...
                    <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="12">
                        ...
                        <div v-else>
                            <vs-button
                                ...
                                @click="editTopic()"
                            >
                                <i class='bx bx-edit-alt' ></i> Edit Audio List
                            </vs-button>
                        </div>
                    </vs-col>
                </vs-row>
