                                    ...
                                    <div class="card">
                                        <div class="card-header table-card-header">
                                            ...
                                            <div class="btn-group btn-group-sm" style="float: right;">
                                                <button type="button" class="footable-add btn btn-primary waves-effect waves-light" style="float: none;margin: 5px;"><router-link style="color: white" to="/resource-text-add"><i class="icofont icofont-plus"></i> Create Text Blog</router-link></button>
                                            </div>
                                        </div>
