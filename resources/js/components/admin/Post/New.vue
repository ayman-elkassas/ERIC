                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Add New Post</h4>
                                        <span>Posts can make as brainstorming between all users can share any information</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                    ...
                                    <div class="card-block">
                                        <form>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea rows="5" cols="5" class="form-control" placeholder="Type your title in placeholder"></textarea>
                                                    <br>
