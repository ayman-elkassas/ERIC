                ...
                <vs-row justify="flex-end">
                    ...
                    <vs-col style="width:14.0%" w="2">
                        <vs-tooltip top>
                            <vs-button
                                ...
                                @click="openAddAdmin()"
                            >
                                <i class='bx bx-plus' ></i> Create Admin
                            </vs-button>
                            <template #tooltip>
                                Add New Admin
                            </template>
                    ...
                    <vs-col style="width:18%" w="2">
                        <vs-tooltip top>
                            ...
                            >
                                <i class='bx bx-trash' ></i> Delete All Admins
                            </vs-button>
                            <template #tooltip>
                                Delete All Admins And Initialize Super Admin Role &#128540;
                            </template>
                        </vs-tooltip>
                        ...
                        <vs-row>
                            <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="12">
                                <div class="center content-inputs">
                                    <vs-input type="text"
                                              label="Admin name"
                                              v-model="request.name" placeholder="Admin name">
                                        <template #icon>
