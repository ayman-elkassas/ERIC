...
// CONCATENATED MODULE: ./src/components/calendar/Calendar.vue?vue&type=template&id=7130a3e5&
  ...
  methods: {
    ...
    enableModality: function enableModality() {
      ...
      if (!this.mask) {
        ...
        setTimeout(function () {
          DomHandler_DomHandler.addClass(_this4.mask, 'p-component-overlay');
        }, 1);
      }
    },
    disableModality: function disableModality() {
      ...
      if (this.mask) {
        ...
        this.mask.addEventListener('transitionend', function () {
          _this5.mask.removeEventListener('click', _this5.maskClickListener);

          _this5.maskClickListener = null;
          document.body.removeChild(_this5.mask);
          _this5.mask = null;
    ...
    isValidSelection: function isValidSelection(value) {
      ...
      if (this.isSingleSelection()) {
        ...
        return _this6.isSelectable(v.getDate(), v.getMonth(), v.getFullYear(), false);
      })) {
        if (this.isRangeSelection()) {
