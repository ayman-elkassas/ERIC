...
.pc-horizontal .topbar .pc-hasmenu:hover > .pc-link .pc-arrow {
    transform: rotate(90deg);
}
...
@media (min-width: 1025px) {
    ...
    .pc-horizontal .topbar .pc-navbar > .pc-hasmenu.dropdown:hover > .pc-link.dropdown-toggle {
        z-index: 1001;
        color: #1c232f;
        position: relative;
    }

    .pc-horizontal .topbar .pc-navbar > .pc-hasmenu.dropdown:hover > .dropdown-menu {
        padding-top: 60px;
        top: 0;
        left: -20px;
    }
...
.pc-chat .c-head .c-action {
    position: absolute;
    right: 30px;
}

.pc-chat .c-head .c-action a {
    color: #293240;
}
...
.pc-chat .c-message p:last-child {
    margin-bottom: 0;
}

.pc-chat .c-message.send {
    float: right;
    background: rgba(114, 103, 239, 0.1);
}

.pc-chat .c-message.receive {
...
.advance-layout {
    background-color: #7267EF;
    background-image: linear-gradient(to bottom, transparent 250px, #f0f2f8 0);
    min-height: 100vh;
}

@media (min-width: 1025px) {
    .advance-layout .pc-sidebar {
        top: calc(70px + 30px);
        bottom: 30px;
        left: 30px;
    }

    .advance-layout .pc-sidebar .navbar-content {
        height: calc(100vh - 70px - 70px);
    }

    .advance-layout .page-header {
        background: transparent;
        box-shadow: none;
        position: absolute;
        top: 20px;
    ...
    .advance-layout .page-header .breadcrumb-item + .breadcrumb-item::before {
    ...
    .advance-layout .page-header .breadcrumb li,
      .advance-layout .page-header .breadcrumb a,
      .advance-layout .page-header h5 {
        color: #fff;
    }

    .advance-layout .pc-header {
        left: 0;
        z-index: 1026;
        box-shadow: none;
    }

    .advance-layout .pc-container {
        margin-left: calc(280px + 30px);
    }

    .advance-layout .pc-container .pcoded-content {
        padding-top: calc(40px + 55px);
    }
}

@media (max-width: 1024px) {
    .advance-layout .pc-header.dark-header .pc-head-link, .advance-layout .pc-header[class*="bg-"] .pc-head-link {
        color: #1c232f !important;
    }

    .advance-layout .pc-header .b-brand {
        display: none;
    }
...
.tab-layout .tab-sidemenu li:focus .nav-link, .tab-layout .tab-sidemenu li:hover .nav-link, .tab-layout .tab-sidemenu li.active .nav-link {
    box-shadow: 0 9px 9px -1px rgba(69, 90, 100, 0.1);
    background: rgba(0, 0, 0, 0.15);
    opacity: 1;
}

.tab-layout .tab-sidemenu li:focus .nav-link:after, .tab-layout .tab-sidemenu li:hover .nav-link:after, .tab-layout .tab-sidemenu li.active .nav-link:after {
    content: "";
    position: absolute;
    right: -24px;
    top: calc(50% - 10px);
...
.pc-horizontal.pc-tab-horizontal .pcoded-content {
    background: #f0f2f8;
    border-radius: 0 0 4px 4px;
    margin-bottom: 50px;
}

.pc-horizontal.pc-tab-horizontal .topbar {
    position: relative;
    height: auto;
    top: calc(70px + 60px);
    background: transparent;
...
.pc-horizontal.pc-tab-horizontal .topbar .pc-tabcontent:not(.active) {
    display: none;
}

.pc-horizontal.pc-tab-horizontal .topbar .tab-sidemenu {
    display: flex;
    align-items: center;
}

.pc-horizontal.pc-tab-horizontal .topbar .navbar-wrapper,
    .pc-horizontal.pc-tab-horizontal .topbar .tab-sidemenu li.active > .nav-link {
    background: #1c232f;
}
...
.pc-horizontal.pc-tab-horizontal .topbar .tab-sidemenu li > .nav-link {
    cursor: pointer;
    padding: 0.7rem 1.4rem;
    border-radius: 6px 6px 0 0;
}

.pc-horizontal.pc-tab-horizontal .topbar.light-sidebar {
    background: transparent;
}

.pc-horizontal.pc-tab-horizontal .topbar.light-sidebar .navbar-wrapper,
      .pc-horizontal.pc-tab-horizontal .topbar.light-sidebar .tab-sidemenu li.active > .nav-link {
    background: #fff;
    color: #1c232f;
}

.pc-horizontal.pc-tab-horizontal .topbar.light-sidebar .tab-sidemenu li > .nav-link {
    background: rgba(255, 255, 255, 0.3);
    color: #fff;
}

@media (max-width: 992px) {
    .pc-horizontal.pc-tab-horizontal .pc-container {
        margin-top: 30px;
    }
}
...
.sw-theme-arrows > ul.step-anchor > li.done > a {
    border-color: #d8d4fb !important;
    color: #7267EF !important;
    background: #d8d4fb !important;
}
